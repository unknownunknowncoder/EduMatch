    ...
    const unsubscribe = ToastState.subscribe((toast$1) => {
      ...
      nextTick(() => {
        ...
        if (existingToastIndex !== -1) {
          ...
          activeToasts.value = [toast$1, ...activeToasts.value];
      });
    });
    onInvalidate(() => {
      unsubscribe();
...
var Toast_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    watchEffect(async () => {
      if (!mounted.value || !toastRef.value)
        return;
      await nextTick();
    ...
    function onPointerUp() {
      ...
      if (swipeOut.value || !dismissible.value)
        return;
    ...
    watchEffect((onInvalidate) => {
      ...
      const startTimer = () => {
        if (remainingTime.value === Infinity)
          return;
      ...
      return openBlock(), createElementBlock("li", {
        ...
        _ctx.toast.cancel ? (openBlock(), createElementBlock("button", {
          ...
          onClick: _cache[0] || (_cache[0] = (event) => {
            var _a2, _b2;
            if (!unref(isAction)(_ctx.toast.cancel))
              return;
        ...
        _ctx.toast.action ? (openBlock(), createElementBlock("button", {
          ...
          onClick: _cache[1] || (_cache[1] = (event) => {
            var _a2, _b2;
            if (!unref(isAction)(_ctx.toast.action))
              return;
...
var Toaster_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props) {
    ...
    const filteredToastsById = computed(() => {
      if (props.id)
        return toasts.value.filter((toast$1) => toast$1.toasterId === props.id);
    ...
    function removeToast(toastToRemove) {
      var _a;
      if (!((_a = toasts.value.find((toast$1) => toast$1.id === toastToRemove.id)) == null ? void 0 : _a.delete))
      ...
      const unsubscribe = ToastState.subscribe((toast$1) => {
        ...
        nextTick(() => {
          ...
          if (indexOfExistingToast !== -1)
            ...
            toasts.value = [toast$1, ...toasts.value];
        });
      });
