...
class CozeAPIServiceProduction {
  ...
  constructor() {
    ...
    // Background Function 的调用路径（使用下划线命名）
    this.baseUrl = isProduction ? '/.netlify/functions/coze-api-fast_background' : 'http://localhost:9999/.netlify/functions/coze-api-fast'
